...
- **WHEN** user runs `agent-computer screenshot`
...
- **WHEN** user runs `agent-computer screenshot --full`
...
- **WHEN** user runs `agent-computer screenshot` on a Retina display
...
- **WHEN** user runs `agent-computer screenshot` without Screen Recording permission
