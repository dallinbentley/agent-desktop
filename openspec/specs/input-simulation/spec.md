...
## Purpose
TBD - created by archiving change mvp-agent-desktop. Update Purpose after archive.
## Requirements
...
- **WHEN** user runs `agent-desktop fill @e4 "new text"` where @e4 contains "old text"
...
- **WHEN** user runs `agent-desktop scroll down 300`
